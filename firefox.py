...
class Mozilla(ModuleInfo):
    ...
    def run(self):
        ...
        #Check if mozilla folder has been found
            ...
            print "\n--------------------------Firefox Password Found!------------------------\n"
            for pwd in pwdFound:

                print pwd.keys()[1] + " : " + pwd.values()[0].encode('cp936')
                print pwd.keys()[2] + " : " + pwd.values()[1].encode('cp936')
                print pwd.keys()[0] + " : " + pwd.values()[2].encode('cp936')
                print ''
